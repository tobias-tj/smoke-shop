...
-- CreateEnum
CREATE TYPE "ProductCategory" AS ENUM ('VAPE', 'ESSENCE', 'ACCESSORY', 'OTHER');

-- CreateEnum
CREATE TYPE "StockMovementType" AS ENUM ('ADD', 'REMOVE', 'ORDER', 'CANCEL');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PREPARING', 'ON_THE_WAY', 'DELIVERED', 'CANCELED');
