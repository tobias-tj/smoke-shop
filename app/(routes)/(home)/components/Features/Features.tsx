  ...
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
      ...
      <p className="max-w-lg mt-5 lg:mt-10 lg:mb-16 text-xl">
        Discover a modern shopping experience built for vape enthusiasts. 
        High-quality products, reliable service, and a store designed to make 
        your purchase smooth and secure.
      </p>
